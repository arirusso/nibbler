...
status (4/30/2011): somewhat working
...
== Install
  ...
  gem install midi-nibbler (not up yet)
...
You can use nibbles in string format.  Note that Nibbler (and Ruby) will consider 0x9 to be 0x09
  
  p nibbler.parse("9", "0", "4", "4", "0", "0")
  #<MIDIMessage::NoteOn:0x98c9818 ...>
...
Nibbler defaults to use {midi-message}[http://github.com/arirusso/midi-message] but it is also possible to generate {midilib}[https://github.com/jimm/midilib] message/event objects 
