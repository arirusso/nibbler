status (4/30/2011): not working yet
...
* you can also optionally use {midilib}[http://github.com/jimm/midilib] for message objects  
	
== Install

  gem install midi-nibbler (*not available yet)
...
Use nibbles
  ...
  p nibbler.parse(0x9, 0x0, 0x4, 0x40, 0x40)
  #<MIDIMessage::NoteOn:0x98c9818 ...>
  
Use nibbles and bytes and strings
  
  p nibbler.parse(0x9, "0", 0x40, "40")
  #<MIDIMessage::NoteOn:0x98c9818 ...>
...
Using {midilib}[https://github.com/jimm/midilib].  (Nibbler defaults to use {midi-message}[http://github.com/arirusso/midi-message] if no :message_lib is specified) 
